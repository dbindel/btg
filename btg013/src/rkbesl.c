/* rkbesl.f -- translated by f2c (version 19951025).
   You must link the resulting object file with the libraries:
	-lf2c -lm   (in that order)

Translation updated, David Bindel.  No longer requires libf2c... now straight C
Translated from Cody's SPECFUN FORTRAN package.
*/

#include <math.h>

#ifndef d_int
#define d_int(x) floor(*x)
#endif
...
/* Subroutine */
int rkbesl_(x, alpha, nb, ize, bk, ncalc)
double *x, *alpha;
int *nb, *ize;
double *bk;
int *ncalc;
{
    ...
    static double r__[5] = { -.48672575865218401848,13.079485869097804016,
    ...
    static double estm[6] = { 52.0583,5.7607,2.7782,14.4303,185.3004,
	    9.3715 };
    static double estf[7] = { 41.8341,7.1075,6.4306,42.511,1.35633,
	    84.5096,20. };
    ...
    /* Builtin functions */
    /*    double log(), exp(), sinh(), sqrt(), d_int(); */

    /* Local variables */
    static int iend;
    static double x2by4, twox, c__;
    static int i__, j, k, m;
    static double blpha;
    static int itemp;
    static double ratio, wminf, d1, d2, d3, f0, f1, f2, p0, q0, t1, t2, 
	    twonu;
    static int mplus1;
    static double dm, ex, bk1, bk2, enu;
...
/* ----------------------------------------------------------
---------- */
/*  Calculate  K(ALPHA+L,X)/K(ALPHA+L-1,X),  L  =  1, 2, ... ,
 NB-1 */
/* ----------------------------------------------------------
---------- */
		*ncalc = -1;
...
/* ----------------------------------------------------------
---------- */
/*  Calculation of K(ALPHA+1,X)/K(ALPHA,X),  1.0 .LE. X .LE. 4
.0 */
/* ----------------------------------------------------------
---------- */
